...
export const AI_FEATURES: {
  ...
  { key: 'create', label: '个性化创建', desc: '打造你的专属虚拟形象', emoji: '🧍‍♀️', icon: 'me', from: '#ffd6e8', to: '#d6a0ff', route: '/pages/body-create/index' },
  { key: 'stylist', label: 'AI 穿搭顾问', desc: '在线问穿搭，实时回答', emoji: '🤖', icon: 'robot', from: '#c9f0e6', to: '#7fd0c0', route: '/pages/stylist/index' },
  { key: 'free', label: '自由搭配', desc: '给形象自由换装试穿', emoji: '🧥', icon: 'outfit-switch', from: '#c9d8ff', to: '#9ab0ff', route: '/pages/free-match/index' },
  { key: 'scene', label: '情景模拟', desc: '看天气 + AI 一键搭配', emoji: '🌦️', icon: 'w-cloud-sun', from: '#c9ecff', to: '#8fc9f0', route: '/pages/scene/index' },
  { key: 'renew', label: '旧衣新生', desc: '旧衣服焕发新搭法', emoji: '♻️', icon: 'recycle', from: '#d6f0d9', to: '#9fceb0', route: '/pages/wardrobe-upload/index' },
  { key: 'accessory', label: '配饰推荐', desc: '按当前服装挑首饰鞋帽', emoji: '💎', icon: 'gem', from: '#f3e0d6', to: '#d8b08f', route: '/pages/accessory/index' },
  { key: 'magazine', label: '时尚杂志', desc: '灵感 & 穿搭思路', emoji: '📖', icon: 'book', from: '#f3e0d6', to: '#d8b08f', route: '/pages/community/index?tab=magazine' },
  { key: 'community', label: '时尚社群', desc: '和同好交流穿搭', emoji: '💬', icon: 'comment', from: '#efe0f0', to: '#c29ad6', route: '/pages/community/index?tab=share' },
  { key: 'custom', label: '差异化定制', desc: '量体裁衣与设计师沟通', emoji: '🧵', icon: 'scissors', from: '#f8d8c7', to: '#d7a7df', route: '/pages/custom/index' },
]
