...
export const STYLE_OPTIONS: Option[] = [
  { id: 'street', label: '休闲街头', desc: '卫衣 / 工装 / 板鞋', emoji: '🧢', color: '#ffd27d', img: '/static/images/style/street.jpg' },
  { id: 'commute', label: '简约通勤', desc: '西装 / 衬衫 / 直筒裤', emoji: '👔', color: '#9ec5ff', img: '/static/images/style/commute.jpg' },
  { id: 'french', label: '法式浪漫', desc: '碎花 / 泡泡袖 / 茶歇裙', emoji: '🌷', color: '#ff9fc0', img: '/static/images/style/french.jpg' },
  { id: 'korean', label: '韩系甜美', desc: '针织 / 百褶裙 / 娃娃领', emoji: '🎀', color: '#ffb3d9', img: '/static/images/style/korean.jpg' },
  { id: 'vintage', label: '复古优雅', desc: '格纹 / 风衣 / 皮革', emoji: '🕰️', color: '#c9a27e', img: '/static/images/style/vintage.jpg' },
  { id: 'sport', label: '运动机能', desc: '冲锋衣 / 束脚裤 / 机能鞋', emoji: '🏃', color: '#8fd6c6', img: '/static/images/style/sport.jpg' },
]

/** 肤色测试：单选 */
export const SKIN_OPTIONS: Option[] = [
  { id: 'cool-fair', label: '冷白皮', desc: '偏粉调、白皙', color: '#fbe6df', img: '/static/images/skin/cool-fair.jpg' },
  { id: 'warm-fair', label: '暖白皮', desc: '偏黄调、白净', color: '#f7dcc4', img: '/static/images/skin/warm-fair.jpg' },
...
export const FACE_OPTIONS: Option[] = [
  ...
  { id: 'square', label: '方脸', desc: '轮廓分明', emoji: '⬜', color: '#c9e4ff', img: '/static/images/face/square.jpg' },
  { id: 'long', label: '长脸', desc: '纵向偏长', emoji: '🥑', color: '#d9f0c9', img: '/static/images/face/long.jpg' },
  { id: 'heart', label: '心形脸', desc: '上宽下窄', emoji: '💗', color: '#ffcfe0', img: '/static/images/face/heart.jpg' },
  { id: 'diamond', label: '菱形脸', desc: '颧骨突出', emoji: '💎', color: '#e0d4ff', img: '/static/images/face/diamond.jpg' },
]
...
export const VISUAL_BODY_OPTIONS: {
  ...
  { id: 'hourglass', label: '沙漏型', desc: '肩臀接近，腰线明显', emoji: '⏳', color: '#ffd1e8', img: '/static/images/body/hourglass.jpg' },
  { id: 'pear', label: '梨形', desc: '下半身比上半身更丰满', emoji: '🍐', color: '#d7f0d1', img: '/static/images/body/pear.jpg' },
  { id: 'rectangle', label: '矩形', desc: '肩、腰、臀比例接近', emoji: '▭', color: '#cfe0ff', img: '/static/images/body/rectangle.jpg' },
  { id: 'apple', label: '苹果形', desc: '腰腹较圆，四肢相对纤细', emoji: '🍎', color: '#ffe4c9', img: '/static/images/body/apple.jpg' },
  { id: 'inverted-triangle', label: '倒三角', desc: '肩部较宽，下半身偏窄', emoji: '🔻', color: '#e5dcff', img: '/static/images/body/inverted-triangle.jpg' },
]
