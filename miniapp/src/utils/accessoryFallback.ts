...
type LocalAccessory = Omit<
  Accessory,
  'categoryLabel' | 'userRating' | 'aggregateRating' | 'ratingCount' | 'matchScore' | 'matchReason' | 'matchReasons'
> & {
  emoji: string
}
...
const LOCAL_ACCESSORIES: LocalAccessory[] = [
  {
    ...
    tryonEnabled: true,
    primaryColor: '#fdf3f6',
    secondaryColor: '#f2cdd8',
    seasons: ['春夏'],
    occasions: ['约会', '聚会'],
    styles: ['french', 'korean'],
    keywords: ['柔和'],
    taobaoUrl: 'https://s.taobao.com/search?q=珍珠耳钉',
    taokouling: '￥珍珠耳钉AI穿搭演示￥',
    favoriteCount: 38,
    basePopularity: 4.7,
    emoji: '🤍',
  },
  {
    ...
    tryonEnabled: true,
    primaryColor: '#eef1f6',
    secondaryColor: '#b9c2d4',
    seasons: ['四季'],
    occasions: ['通勤', '日常'],
    styles: ['commute', 'vintage'],
    keywords: ['利落'],
    taobaoUrl: 'https://s.taobao.com/search?q=几何银项链',
    taokouling: '￥几何银项链AI穿搭演示￥',
    favoriteCount: 31,
    basePopularity: 4.5,
    emoji: '📿',
  },
  {
    ...
    styles: ['street'],
    keywords: ['个性'],
    taobaoUrl: 'https://s.taobao.com/search?q=金属环耳夹',
    taokouling: '￥金属环耳夹AI穿搭演示￥',
    favoriteCount: 24,
    basePopularity: 4.4,
    emoji: '💫',
  },
  {
    ...
    tryonEnabled: true,
    primaryColor: '#ffd6c9',
    secondaryColor: '#ff9e86',
    seasons: ['秋冬'],
    occasions: ['日常', '旅行'],
    styles: ['street', 'sport'],
    keywords: ['保暖'],
    taobaoUrl: 'https://s.taobao.com/search?q=针织毛线帽',
    taokouling: '￥针织毛线帽AI穿搭演示￥',
    favoriteCount: 33,
    basePopularity: 4.6,
    emoji: '🧢',
  },
  {
    ...
    tryonEnabled: true,
    primaryColor: '#d8c3a5',
    secondaryColor: '#a9885c',
    seasons: ['春秋', '秋冬'],
    occasions: ['约会', '聚会'],
    styles: ['french', 'vintage'],
    keywords: ['复古'],
    taobaoUrl: 'https://s.taobao.com/search?q=法式贝雷帽',
    taokouling: '￥法式贝雷帽AI穿搭演示￥',
    favoriteCount: 27,
    basePopularity: 4.5,
    emoji: '👒',
  },
  {
    ...
    tryonEnabled: true,
    primaryColor: '#d6e4f0',
    secondaryColor: '#9ab6d8',
    seasons: ['春夏'],
    occasions: ['街头', '旅行'],
    styles: ['street', 'sport'],
    keywords: ['休闲'],
    taobaoUrl: 'https://s.taobao.com/search?q=基础棒球帽',
    taokouling: '￥基础棒球帽AI穿搭演示￥',
    favoriteCount: 25,
    basePopularity: 4.3,
    emoji: '🧢',
  },
  {
    ...
    tryonEnabled: true,
    primaryColor: '#f0d3d0',
    secondaryColor: '#c98f8a',
    seasons: ['秋冬'],
    occasions: ['通勤', '日常'],
    styles: ['vintage'],
    keywords: ['复古'],
    taobaoUrl: 'https://s.taobao.com/search?q=格纹羊毛围巾',
    taokouling: '￥格纹羊毛围巾AI穿搭演示￥',
    favoriteCount: 36,
    basePopularity: 4.7,
    emoji: '🧣',
  },
  {
    ...
    styles: ['french', 'korean'],
    keywords: ['浪漫'],
    taobaoUrl: 'https://s.taobao.com/search?q=轻纱丝巾',
    taokouling: '￥轻纱丝巾AI穿搭演示￥',
    favoriteCount: 30,
    basePopularity: 4.5,
    emoji: '🎀',
  },
  {
    ...
    tryonEnabled: false,
    primaryColor: '#f3ead6',
    secondaryColor: '#cbb488',
    seasons: ['秋冬'],
    occasions: ['通勤', '旅行'],
    styles: ['commute', 'vintage'],
    keywords: ['高级'],
    taobaoUrl: 'https://s.taobao.com/search?q=羊绒披肩',
    taokouling: '￥羊绒披肩AI穿搭演示￥',
    favoriteCount: 22,
    basePopularity: 4.4,
    emoji: '🧥',
  },
  {
    ...
    styles: ['commute'],
    keywords: ['收腰'],
    taobaoUrl: 'https://s.taobao.com/search?q=细款通勤腰带',
    taokouling: '￥细款通勤腰带AI穿搭演示￥',
    favoriteCount: 26,
    basePopularity: 4.4,
    emoji: '🪢',
  },
  {
    ...
    tryonEnabled: false,
    primaryColor: '#e7e2f0',
    secondaryColor: '#b3a0d8',
    seasons: ['四季'],
    occasions: ['街头', '聚会'],
    styles: ['street', 'vintage'],
    keywords: ['金属'],
    taobaoUrl: 'https://s.taobao.com/search?q=金属扣腰带',
    taokouling: '￥金属扣腰带AI穿搭演示￥',
    favoriteCount: 23,
    basePopularity: 4.3,
    emoji: '🔗',
  },
  {
    ...
    tryonEnabled: true,
    primaryColor: '#c9a27e',
    secondaryColor: '#8f6744',
    seasons: ['春夏'],
    occasions: ['旅行', '日常'],
    styles: ['street', 'vintage'],
    keywords: ['自然'],
    taobaoUrl: 'https://s.taobao.com/search?q=编织腰带',
    taokouling: '￥编织腰带AI穿搭演示￥',
    favoriteCount: 20,
    basePopularity: 4.2,
    emoji: '🧶',
  },
  {
    ...
    styles: ['street', 'sport'],
    keywords: ['百搭'],
    taobaoUrl: 'https://s.taobao.com/search?q=厚底小白鞋',
    taokouling: '￥厚底小白鞋AI穿搭演示￥',
    favoriteCount: 42,
    basePopularity: 4.8,
    emoji: '👟',
  },
  {
    ...
    tryonEnabled: true,
    primaryColor: '#ffdfe9',
    secondaryColor: '#ff9ec2',
    seasons: ['春夏'],
    occasions: ['约会', '聚会', '日常'],
    styles: ['french', 'korean'],
    keywords: ['甜美'],
    taobaoUrl: 'https://s.taobao.com/search?q=玛丽珍单鞋',
    taokouling: '￥玛丽珍单鞋AI穿搭演示￥',
    favoriteCount: 35,
    basePopularity: 4.6,
    emoji: '🥿',
  },
  {
    ...
    styles: ['commute', 'vintage'],
    keywords: ['利落'],
    taobaoUrl: 'https://s.taobao.com/search?q=切尔西短靴',
    taokouling: '￥切尔西短靴AI穿搭演示￥',
    favoriteCount: 28,
    basePopularity: 4.5,
    emoji: '🥾',
  },
...
function pickThemeItem(category: string, theme: HotComboTheme) {
  ...
  return LOCAL_ACCESSORIES.filter((item) => item.category === category).sort(
    (a, b) => themeScore(b) - themeScore(a) || b.basePopularity - a.basePopularity,
  )[0]
}
...
export function buildFallbackRecommendations(outfit: AccessoryContextItem[]): AccessoryRecommendations {
  const ratings = loadRatings()
  const categories = Object.keys(CATEGORY_LABELS).map((key) => ({
    key,
    label: CATEGORY_LABELS[key],
    items: LOCAL_ACCESSORIES.filter((item) => item.category === key)
  ...
  const hotCombos = HOT_COMBO_THEMES.map((theme) => {
    const items = Object.keys(CATEGORY_LABELS)
      ...
      .filter(Boolean)
    const avgScore = items.length ? items.reduce((sum, item) => sum + item.basePopularity, 0) / items.length : 3.5
    return {
      id: theme.id,
      title: theme.title,
      subtitle: '本地演示数据',
