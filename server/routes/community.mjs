...
router.post(
  '/contents/:id/interactions',
  asyncHandler(async (req, res) => {
    const result = await communityService.toggleInteraction(req.userId, req.params.id, req.body?.action)
    res.json(result)
  }),
)
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    const comment = await communityService.addComment(req.userId, req.params.id, req.body?.content)
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    const result = await communityService.saveBookmark(req.userId, req.params.id, req.body?.note)
    res.json(result)
  }),
)
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    const result = await communityService.completeTutorial(req.userId, req.params.id)
    res.json(result)
  }),
)
